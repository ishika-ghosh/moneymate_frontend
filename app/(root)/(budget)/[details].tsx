    ...
    loading ? <Loading /> :
      !modal ?
        <ScrollView className='px-4'>
          ...
          {analysis.length > 0 &&
            <View className='bg-gray-80 absolute top-0 left-0 w-full h-auto pb-20'>
...
const ExpenseItem = ({ item, handleDelete }: any) => (
  <View className='px-4 w-full mt-3 bg-gray-100 rounded-xl'>
    <View className='py-2'>
    ...
    <View className='absolute bottom-2 right-2 bg-gray-100'>
