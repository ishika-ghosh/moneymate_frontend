...
export default function SignIn() {
  ...
  return (
    <View className='flex-1 items-center relative px-5'>
      <Text className='font-JakartaSemiBold text-xl mt-12 text-center text-gray-20 capitalize'>Sign Into your your account with Google in just one click</Text>
      <Text className='text-center mt-5 text-gray-30 text-sm font-extralight'>Sign in to manage your personal and shared expenses effortlessly. Keep track of your spending and settle group expenses with ease</Text>
